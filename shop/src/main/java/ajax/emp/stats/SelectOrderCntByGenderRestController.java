 ...
 */
@WebServlet("/emp/stats/orderCntByGender")
public class SelectOrderCntByGenderRestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		orderList = statsDao.selectOrderCntByGender(fromYM, toYM);
