 ...
 */
@WebServlet("/emp/stats/orderPriceSumByGender")
public class SelectOrderPriceSumByGenderRestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		orderList = statsDao.selectOrderPriceSumByGender(fromYM, toYM);
