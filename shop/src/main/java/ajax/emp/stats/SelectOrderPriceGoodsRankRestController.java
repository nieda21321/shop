 ...
 */
@WebServlet("/emp/stats/orderPriceGoodsRank")
public class SelectOrderPriceGoodsRankRestController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		orderList = statsDao.selectOrderPriceGoodsRank(fromYM, toYM);
